...
class PolicyMakeCommand extends BaseCommand
{
    ...
    protected function replaceModel($stub, $model)
    {
        ...
        $namespaceModel = $this->parseClass($model, config('ac-developers.generator.namespaces.models', ''));
    ...
    {
        return $rootNamespace.config('ac-developers.generator.namespaces.policies', '\Policies');
    }
